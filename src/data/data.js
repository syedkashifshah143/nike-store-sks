...
const heroapi = {
  ...
  sociallinks: [
    { icon: FaGithub, colorClass: 'bg-gray-800', url: 'https://github.com/syedkashifshah143' },
    { icon: FaLinkedin, colorClass: 'bg-blue-600', url: 'https://www.linkedin.com/in/syedkashifshah143/' },
    { icon: FaSquareUpwork, colorClass: 'bg-green-500', url: 'https://www.upwork.com/freelancers/~01f0a2e0476db2ea6d' },
  ],
